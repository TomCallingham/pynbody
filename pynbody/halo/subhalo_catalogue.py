...
class SubhaloCatalogue(HaloCatalogue):
    ...
    def __init__(self, full_halo_catalogue: HaloCatalogue, subhalo_numbers: NDArray[int]):
        ...
        self._full_halo_catalogue = full_halo_catalogue
        self._subhalo_numbers = subhalo_numbers
        super().__init__(full_halo_catalogue.base, number_mapping.SimpleHaloNumberMapper(0, len(subhalo_numbers)))
    ...
    def _get_halo(self, halo_number):
        return self._full_halo_catalogue._get_halo(self._subhalo_numbers[halo_number])
